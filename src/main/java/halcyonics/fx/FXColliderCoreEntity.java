...
public class FXColliderCoreEntity extends EntityFX {
    ...
    public FXColliderCoreEntity(World world, double d, double d1, double d2, float f, float f1, float f2, float scale) {
    ...
    public void renderParticle(WorldRenderer wr, Entity p_180434_2_, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        GL11.glTranslated(var13 + this.sx + 0.95D, var14 + this.sy + 0.95D, var15 + this.sz + 0.95D);
        ...
        wr.pos(-0.5D * (double) var12, 0.5D * (double) var12, 0.0D).tex(0.0D, 1.0D).color(this.particleRed * var16, this.particleGreen * var16, this.particleBlue * var16, this.particleAlpha * 5.0F).lightmap(j, k).endVertex();
        wr.pos(0.5D * (double) var12, 0.5D * (double) var12, 0.0D).tex(1.0D, 1.0D).color(this.particleRed * var16, this.particleGreen * var16, this.particleBlue * var16, this.particleAlpha * 5.0F).lightmap(j, k).endVertex();
        wr.pos(0.5D * (double) var12, -0.5D * (double) var12, 0.0D).tex(1.0D, 0.0D).color(this.particleRed * var16, this.particleGreen * var16, this.particleBlue * var16, this.particleAlpha * 5.0F).lightmap(j, k).endVertex();
        wr.pos(-0.5D * (double) var12, -0.5D * (double) var12, 0.0D).tex(0.0D, 0.0D).color(this.particleRed * var16, this.particleGreen * var16, this.particleBlue * var16, this.particleAlpha * 5.0F).lightmap(j, k).endVertex();

        GL11.glRotatef(90.0F, rotationX, rotationY + 90F, rotationZ);
        GL11.glRotatef((float) this.rotation, 0.0F, 0.0F, 1.0F);
        wr.pos(-0.5D * (double) var12, 0.5D * (double) var12, 0.0D).tex(0.0D, 1.0D).color(this.particleRed * var16, this.particleGreen * var16, this.particleBlue * var16, this.particleAlpha * 5.0F).lightmap(j, k).endVertex();
        wr.pos(0.5D * (double) var12, 0.5D * (double) var12, 0.0D).tex(1.0D, 1.0D).color(this.particleRed * var16, this.particleGreen * var16, this.particleBlue * var16, this.particleAlpha * 5.0F).lightmap(j, k).endVertex();
        wr.pos(0.5D * (double) var12, -0.5D * (double) var12, 0.0D).tex(1.0D, 0.0D).color(this.particleRed * var16, this.particleGreen * var16, this.particleBlue * var16, this.particleAlpha * 5.0F).lightmap(j, k).endVertex();
