...
public class ItemBlockColliderBlock extends ItemBlock {

    public ItemBlockColliderBlock(Block p_i45328_1_) {
        super(p_i45328_1_);
    }
    ...
    public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List p_77624_3_, boolean p_77624_4_) {
        ...
        p_77624_3_.add("");
        p_77624_3_.add(StatCollector.translateToLocal("colliderblock.info"));
        p_77624_3_.add("");
        p_77624_3_.add(EnumChatFormatting.LIGHT_PURPLE + StatCollector.translateToLocal("block.usable.frame") + EnumChatFormatting.WHITE +" "+ StatCollector.translateToLocal("block.usable.yes"));
