...
/**
 * BlocksHandler on this whitelist will not resist an explosion but won't be destroyed.
 *
...
public final class ExplosionWhitelist {
	...
	private static Set<Block> whitelist = Collections.newSetFromMap(new IdentityHashMap<Block, Boolean>());
}
